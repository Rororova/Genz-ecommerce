          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`px-4 py-2 border-2 border-black font-bold text-sm shadow-[2px_2px_0px_0px_#888] transition-all ${filter === 'all'
                  ? 'bg-black text-white'
              ...
              <button
                ...
                className={`px-4 py-2 border-2 border-black font-bold text-sm shadow-[2px_2px_0px_0px_#000] transition-all ${filter === 'velvet'
                  ? 'bg-black text-white'
                  : 'bg-white hover:bg-yellow-100'
                  }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 border-2 border-black font-bold text-sm shadow-[2px_2px_0px_0px_#000] transition-all ${filter === 'leather'
                  ? 'bg-black text-white'
                  : 'bg-white hover:bg-yellow-100'
                  }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 border-2 border-black font-bold text-sm shadow-[2px_2px_0px_0px_#000] transition-all ${filter === 'fabric'
                  ? 'bg-black text-white'
                  : 'bg-white hover:bg-yellow-100'
                  }`}
              >
